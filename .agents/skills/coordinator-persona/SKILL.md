...
* **Read-Only Database Access**: You are permitted to read/query Supabase and Supermemory databases. You are strictly blocked from writing or syncing data (reserved for Librarian).
