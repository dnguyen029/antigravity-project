...
description: Manages the swarm's long-term memory (Supabase/Supermemory). Archives patterns and lessons tagged with #AISP-V1.
metadata:
  version: '2.0'
  author: 'Antigravity'
category: system
...
2. **Archival**: Extracted lessons are pushed to the `lessons_learned` table in Supabase and semanticized in Supermemory.
